 ...
 * @author Nuvem Shop
 */
public class IdiomSwing extends javax.swing.JFrame {

    /**
     * Creates new form IdiomSwing
     */
    public IdiomSwing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/world-flags1.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblIdioma, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
    ...
    private void btnIdiomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIdiomaActionPerformed
        ...
        lblIdioma.setText(local.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdiomSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IdiomSwing().setVisible(true);
            }
        });
    }
